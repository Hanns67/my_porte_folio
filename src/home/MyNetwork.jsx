...
export function MyNet() {
    return (
        <>
            <div className="my_network">
                <div className="item_my_network">
                    <a href="https://github.com/Hanns67/">
                ...
                <div className="item_my_network">
                    <a href="https://www.linkedin.com/in/hanns-nzoyem-989076318/">
                        <TERipple rippleColor="light">
                            <button
                                type="button"
                                className="inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                ...
                <div className="item_my_network">
                    <a href="https://wa.me/237673451442"><TERipple rippleColor="light">
                        <button
                            type="button"
                            className="inline-block rounded px-6 py-2.5 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
